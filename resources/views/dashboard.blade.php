    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="{{ route('admin.products.export') }}" class="flex items-center gap-2 group px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-xl font-bold text-xs transition-all border border-blue-100 shadow-sm">
                ...
                <a href="{{ route('analytics.index') }}" class="flex items-center gap-2 group px-4 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-xl font-bold text-xs transition-all border border-indigo-100 shadow-sm">
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl shadow-lg border border-indigo-500 overflow-hidden group">
                        <div class="p-6">
                            ...
                            <a href="{{ route('analytics.index') }}" class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-white text-indigo-700 rounded-xl font-bold text-sm transition-all hover:bg-indigo-50 shadow-md">
