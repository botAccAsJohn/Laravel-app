...
<div class="max-w-3xl mx-auto px-4 py-8">
    ...
    <div class="bg-white shadow-md rounded-lg p-6 space-y-6">
        <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <span id="order-status-badge" data-order-id="{{ $order->id }}" class="inline-flex items-center px-3 py-1 text-sm font-medium border rounded-full {{ $badgeClass }}">
                {{ ucfirst($status) }}
            </span>
        </div>
...
@push('scripts')
    ...
    @vite(['resources/js/orderStatus.js'])
@endpush
