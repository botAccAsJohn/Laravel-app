        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.06); margin: 0 auto; max-width: 600px; width: 100%;">
          ...
          <tr>
            <td align="center" style="background-color: #0f766e; background: linear-gradient(135deg, #0f766e 0%, #14b8a6 100%); padding: 60px 30px;">
                ...
                <!-- Heading -->
                <h1 style="color: #ffffff; font-size: 32px; margin: 0; font-weight: 800; letter-spacing: -0.5px;">Payment Received!</h1>
                <p style="color: #ccfbf1; font-size: 18px; margin: 12px 0 0 0; font-weight: 400;">Thank you for your payment.</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px 40px 10px 40px;">
              ...
              <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin: 0;">
                We have successfully processed your payment for your order. We are now preparing your items for shipment.
              </p>
            </td>
          </tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 16px;">
                      <tr>
                        ...
                        <td align="right" style="width: 50%;">
                            <span style="color: #64748b; font-size: 13px; text-transform: uppercase; letter-spacing: 1px; font-weight: 600; display: block; margin-bottom: 4px;">Amount Paid</span>
                            <span style="color: #0f766e; font-size: 22px; font-weight: 800;">${{ number_format($orderTotal, 2) }}</span>
                        </td>
                      </tr>
                    </table>
          ...
          <tr>
            <td align="center" style="padding: 24px 40px 40px 40px;">
              <a href="{{ url('/orders/' . $orderId) }}" style="background-color: #0f766e; color: #ffffff; text-decoration: none; padding: 18px 40px; border-radius: 50px; font-size: 16px; font-weight: 600; display: inline-block; transition: all 0.2s; box-shadow: 0 4px 12px rgba(15, 118, 110, 0.2);">
                View Details
              </a>
            </td>
          </tr>
