    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.06); margin: 0 auto; max-width: 600px; width: 100%;">
          ...
          <tr>
            <td align="center" style="background-color: #6d28d9; background: linear-gradient(135deg, #6d28d9 0%, #8b5cf6 100%); padding: 60px 30px;">
                <!-- Icon -->
                ...
                <!-- Heading -->
                <h1 style="color: #ffffff; font-size: 32px; margin: 0; font-weight: 800; letter-spacing: -0.5px;">Order Delivered!</h1>
                <p style="color: #ddd6fe; font-size: 18px; margin: 12px 0 0 0; font-weight: 400;">Your package has arrived.</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px 40px 10px 40px;">
              ...
              <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin: 0;">
                Great news! Your order has been successfully delivered. We hope you enjoy your items. Thank you for shopping with us!
              </p>
            </td>
          </tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 16px;">
                      <tr>
                        ...
                        <td align="right" style="width: 50%;">
                            ...
                            <span style="color: #6d28d9; font-size: 22px; font-weight: 800;">${{ number_format($orderTotal, 2) }}</span>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td align="left">
                            ...
                            <span style="color: #0f172a; font-size: 16px; font-weight: 500;">{{ $itemsCount }} {{ \Illuminate\Support\Str::plural('item', $itemsCount) }} in this order</span>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td align="center" style="padding: 24px 40px 40px 40px;">
              <a href="{{ url('/orders/' . $orderId) }}" style="background-color: #6d28d9; color: #ffffff; text-decoration: none; padding: 18px 40px; border-radius: 50px; font-size: 16px; font-weight: 600; display: inline-block; transition: all 0.2s; box-shadow: 0 4px 12px rgba(109, 40, 217, 0.2);">
                Review Your Order
              </a>
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="background-color: #f8fafc; padding: 32px 40px; border-top: 1px solid #f1f5f9;">
              ...
              <p style="color: #64748b; font-size: 15px; margin: 0 0 16px 0;">
                Reply to this email or reach us at <a href="mailto:support@yourbrand.com" style="color: #8b5cf6; text-decoration: none; font-weight: 500;">support@yourbrand.com</a>
              </p>
