    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.06); margin: 0 auto; max-width: 600px; width: 100%;">
          ...
          <tr>
            <td align="center" style="background-color: #1e3a8a; background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); padding: 60px 30px;">
                <!-- Icon -->
                ...
                <p style="color: #bfdbfe; font-size: 18px; margin: 12px 0 0 0; font-weight: 400;">Your order is being processed.</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px 40px 10px 40px;">
              ...
              <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin: 0;">
                Thanks for shopping with us! We're getting your items ready for shipment. You'll receive another notification once it's on the way.
              </p>
            </td>
          </tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 16px;">
                      <tr>
                        ...
                        <td align="right" style="width: 50%;">
                            ...
                            <span style="color: #3b82f6; font-size: 22px; font-weight: 800;">${{ number_format($orderTotal, 2) }}</span>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td align="left">
                            ...
                            <span style="color: #0f172a; font-size: 16px; font-weight: 500;">{{ $itemsCount }} {{ Str::plural('item', $itemsCount) }} in this order</span>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td align="center" style="background-color: #f8fafc; padding: 32px 40px; border-top: 1px solid #f1f5f9;">
              ...
              <p style="color: #64748b; font-size: 15px; margin: 0 0 16px 0;">
                Reply to this email or reach us at <a href="mailto:support@yourbrand.com" style="color: #3b82f6; text-decoration: none; font-weight: 500;">support@yourbrand.com</a>
              </p>
