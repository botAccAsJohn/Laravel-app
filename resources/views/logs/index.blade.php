    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
            ...
            <form method="GET" action="{{ route('admin.logs.index') }}"
                class="flex items-center space-x-3 bg-white p-2 rounded-lg shadow-sm border border-gray-100">
        ...
        <div class="bg-gray-900 rounded-xl p-6 overflow-x-auto shadow-lg border border-gray-800">
            <div class="flex items-center mb-4 space-x-2">
                ...
                <span
                    class="text-gray-400 text-xs font-mono ml-4">storage/logs/{{ $logType }}/{{ $logType }}-{{ date('Y-m-d') }}.log</span>
            </div>
