    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="hidden sm:flex items-center gap-4">
                {{-- Export Button --}}
                <a href="{{ route('analytics.export') }}" class="flex items-center gap-2 px-4 py-2 bg-white text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-xl font-bold text-sm transition-all border border-emerald-100 shadow-sm group">
