    ...
    public function run(): void
    {
        ...
        $roles = [
            ...
            [
                ...
                'permissions' => ['manage_products', 'view_products', 'import_products', 'manage_orders', 'view_orders', 'view_reports', 'manage_reports', 'view_analytics', 'manage_support', 'send_alerts'],
            ],
            [
