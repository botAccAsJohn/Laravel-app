...
class SendOrderConfirmationMail extends Mailable implements ShouldQueue
{
    ...
    public function __construct($order = null)
    {
        if ($order) {
            ...
            $this->orderId     = $order->order_number ?? $order->id;
        } else {
            // Dummy data for testing the UI
            $this->customerName = 'John Doe';
            $this->orderTotal  = 249.50;
            $this->itemsCount  = 3;
            $this->orderId     = 'CONF-98452';
        }
    }
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: 'Your Order Confirmation Mail',
        );
    }
