...
class RoleController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $roleCounts = \Illuminate\Support\Facades\DB::table(config('permission.table_names.model_has_roles'))
        ...
        $roles->each(function (Role $role) use ($adminCount, $roleCounts) {
            if ($role->name === 'admin') {
        ...
        $permissions = Permission::where('guard_name', 'web')->orderBy('group')->orderBy('display_name')->get()
            ->groupBy('group');
